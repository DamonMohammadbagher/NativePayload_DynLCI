    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("NativePayload_DynLCE , Published by Damon Mohammadbagher , 2018-2019");
                Console.ForegroundColor = ConsoleColor.Gray;
                Console.WriteLine("NativePayload_DynLCE , Dynamic Local Code Invoke , Injecting Meterpreter Payload bytes into local Process");
                Console.WriteLine();
